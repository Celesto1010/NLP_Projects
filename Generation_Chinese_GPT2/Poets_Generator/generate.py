...
def main():
    ...
    parser.add_argument('--length', default=300, type=int, required=False, help='生成长度')
    ...
    parser.add_argument('--model_dir', default='model_epoch_25', type=str, required=False, help='模型路径')
    parser.add_argument('--prefix', default='结庐在人境', type=str, required=False, help='生成文章的开头')
